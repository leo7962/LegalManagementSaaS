...
- Cree un proyecto de React con create-vite: `npm init --yes vite@latest legalmanagementsaas.client -- --template=react-ts  --no-rolldown --no-immediate`.
...
- Crear archivo de proyecto (`legalmanagementsaas.client.esproj`).
